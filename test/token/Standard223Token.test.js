// Zeppelin tests for ERC20 StandardToken. Run against Standard223Token to check full backwards compatibility.

import assertRevert from '../helpers/assertRevert';

var Standard223TokenMock = artifacts.require('mocks/Standard223TokenMock.sol');

contract('Standard223Token', function(accounts) {
  let token;

  beforeEach(async function () {
    token = await Standard223TokenMock.new(accounts[0], 100);
  });
  ...
  it('should return the correct allowance amount after approval', async function () {
    let token = await Standard223TokenMock.new();
  ...
  it('should return correct balances after transfer', async function () {
    let token = await Standard223TokenMock.new(accounts[0], 100);
